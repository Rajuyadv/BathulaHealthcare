				                        ...
				                        <div class="row">
				                            <div class="col-md-9">
				                                    ...
				                                    <div class="col-md-4">
				                                        <div class="form-group">
				                                            ...
				                                            <form:select class="form-control" path="hospitalName" style="">
																...
																<form:options items="${hospList}"></form:options>
															</form:select>
				                                ...
				                                <div class="row">
				                                    <div class="col-md-4">
				                                        <div class="form-group">
				                                            ...
				                                            <form:input class="form-control" path="firstName" type="text"></form:input>
												...
												<div class="row">
				                                    <div class="col-md-4">
				                                        <div class="form-group">
															<label class="control-label"><label for="User_Email">ProfileDocuments</label> <span class="required">*</span></label>
				                                            <!-- <input class="form-control" data-val="true" data-val-regex="Enter valid email." data-val-regex-pattern="^[\w\+\-\._]+@[\w\-\._]+\.\w{2,}$" data-val-required="The Email (User Name) field is required." id="User_Email" maxlength="50" name="User.Email" type="text" value=""> -->
				                                            <form:input class="form-control" path="profileDocuments" type="text" ></form:input>
				                                            <span class="field-validation-valid" data-valmsg-for="User.Email" data-valmsg-replace="true"></span>
				                                        </div>
													</div>						                                    
													<div class="col-md-4">
													<div class="form-group">
															<form:radiobutton path="status" id="status"  value="active"/>Active
														   <form:radiobutton path="status" id="status"  value="inactive"/>InActive
														</div>
													</div>
												</div>
											</div>
